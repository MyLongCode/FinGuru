...
export default function BigDealCard({ name, description, amount, details, onClick, onClose, isOpen, headerLabel = 'Цена', rightAlign = false }: BigDealCardProps): ReactNode {
